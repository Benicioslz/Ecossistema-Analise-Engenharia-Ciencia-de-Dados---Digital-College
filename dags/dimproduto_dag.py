...
def etl_dim_produto():
    ...
    def load_mssql(rows):
        ...
        insert_sql = "INSERT INTO #ProdutoStaging (id_dim_produto, id_fornecedor, categoria, descricao_produto) VALUES (%s, %s, %s, %s)"
        ...
        merge_sql = """
            MERGE DataWarehouse.dbo.DimProduto AS Target
            USING #ProdutoStaging AS Source
            ON (Target.id_dim_produto = Source.id_dim_produto)
            ...
            WHEN NOT MATCHED BY TARGET THEN
                INSERT (id_dim_produto, id_fornecedor, categoria, descricao_produto)
                VALUES (Source.id_dim_produto, Source.id_fornecedor, Source.categoria, Source.descricao_produto);
        """
