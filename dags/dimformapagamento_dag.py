...
def etl_dim_forma_pagamento():
    ...
    def load_mssql(rows):
        ...
        insert_sql = "INSERT INTO #FormaPagtoStaging (id_dim_forma_pagamento, descricao_forma_pagamento) VALUES (%s, %s)"
        ...
        merge_sql = """
            MERGE DataWarehouse.dbo.DimFormaPagamento AS Target
            USING #FormaPagtoStaging AS Source
            ON (Target.id_dim_forma_pagamento = Source.id_dim_forma_pagamento)
            ...
            WHEN NOT MATCHED BY TARGET THEN
                INSERT (id_dim_forma_pagamento, descricao_forma_pagamento)
                VALUES (Source.id_dim_forma_pagamento, Source.descricao_forma_pagamento);
        """
